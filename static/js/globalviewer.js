;(function (root, factory) {
  ...
  function ua(a) {
    this.message = "Assertion failed. error is /#" + a + " .";
    this.code = a;
...
*/
  ...
  function zb(a) {
    yb.call(this, {
      code: a, units: "m", extent: Ab, global: !0, worldExtent: Bb, getPointResolution: function (a, c) {
  ...
  v(zb, yb);
  var Cb = 6378137 * Math.PI, Ab = [-Cb, -Cb, Cb, Cb], Bb = [-180, -85, 180, 85],
  ...
  v(Gb, yb);
  var Hb = [-180, -90, 180, 90], Ib = 6378137 * Math.PI / 180,
  ...
  function y(a, b, c, d, e) {
    ...
    (f = Cc(g, c, d, !1)) ? e || (f.th = !1) : (f = {
      ...
      target: a,
      type: b
    }, a.addEventListener(b, yc(f)), g.push(f));
    return f
  }
  ...
  function Id(a, b) {
    ...
    Ld = -1 !== Kd.indexOf("firefox"), Md = -1 !== Kd.indexOf("safari") && -1 == Kd.indexOf("chrom"),
    Nd = -1 !== Kd.indexOf("webkit") && -1 == Kd.indexOf("edge"), Od = -1 !== Kd.indexOf("macintosh"),
    ...
    Wd = !!navigator.msPointerEnabled, Xd = !1, Yd, Zd = [];
  ...
  k.Xf = function (a, b) {
    ...
    }, e) : (this.Yc(c), this.qb(a), setTimeout(e.bind(void 0, !0), 0))
  };
  k.Fk = function (a, b, c) {
  ...
  function gh(a) {
    ...
    if (this.l === hh) {
      ...
      0 < g ? b.animate({resolution: e, easing: od, anchor: this.a, duration: 500}) : 0 > g && b.animate({
        resolution: f,
        easing: od,
        anchor: this.a,
        duration: 500
  ...
  function ci(a, b) {
    ...
    d ? (d.lineCap != b.lineCap && (d.lineCap = c.lineCap = b.lineCap), Qd && (ma(d.lineDash, b.lineDash) || c.setLineDash(d.lineDash = b.lineDash), d.lineDashOffset != b.lineDashOffset && (d.lineDashOffset = c.lineDashOffset = b.lineDashOffset)), d.lineJoin != b.lineJoin && (d.lineJoin = c.lineJoin = b.lineJoin), d.lineWidth != b.lineWidth && (d.lineWidth = c.lineWidth = b.lineWidth), d.miterLimit != b.miterLimit && (d.miterLimit = c.miterLimit = b.miterLimit), d.strokeStyle != b.strokeStyle && (d.strokeStyle = c.strokeStyle = b.strokeStyle)) :
      (c.lineCap = b.lineCap, Qd && (c.setLineDash(b.lineDash), c.lineDashOffset = b.lineDashOffset), c.lineJoin = b.lineJoin, c.lineWidth = b.lineWidth, c.miterLimit = b.miterLimit, c.strokeStyle = b.strokeStyle, a.S = {
        lineCap: b.lineCap,
        lineDash: b.lineDash,
  ...
  function gj(a, b, c, d) {
    var e, f = a.a.length, g = a.b.length, h = "bevel" === a.c.lineJoin ? 0 : "miter" === a.c.lineJoin ? 1 : 2,
      l = "butt" === a.c.lineCap ? 0 : "square" === a.c.lineCap ? 1 : 2, m = $i(b, c, d), n = g, p = 1;
    for (e = 0; e < c; e += d) {
      var q = f / 7;
      var t = u;
      var u = x || [b[e], b[e + 1]];
    ...
    do {
      ...
      if (!1 === t.Eb) {
        ...
        !d && Uj({
          Z: q,
          W: u
        }, c).length || !x || !d && !1 !== q.Eb && !1 !== u.Eb && Sf([h.Z.x, h.Z.y, q.x, q.y, t.x, t.y, u.x, u.y, n.W.x, n.W.y], 0, 10, 2) !== !e || (a.b[f++] = q.kb, a.b[f++] = t.kb, a.b[f++] = u.kb, Zj(l, m, b, c), m === g && (g = n), p = !0)
      }
      h = Gj(b);
      l = Hj(b);
      m = Dj(b);
  ...
  function bk(a, b, c, d, e) {
    var f, g, h = [],
      l = Mj(d, [Math.min(a.x, b.x, c.x), Math.min(a.y, b.y, c.y), Math.max(a.x, b.x, c.x), Math.max(a.y, b.y, c.y)]);
    d = 0;
  ...
  gk.prototype.add = function (a, b, c, d, e) {
    ...
    for (f = this.a.length; g < f; ++g) {
      ...
      if (h.width >= b + this.b && h.height >= c + this.b) return f = {
        ...
        width: h.width - b,
        height: h.height
      }, b = {x: h.x, y: h.y + d, width: b, height: h.height - d}, hk(this, a, c, b)) : (c = {
        x: h.x + b,
        y: h.y,
        width: h.width - b,
        height: d
  ...
  k.Qb = function (a, b, c, d, e, f) {
    if (this.ua) {
      ...
      e = this.l;
      f = this.ua.split("\n");
      var g = nk(this, f), h, l, m = Math.round(g[0] * this.jb - this.ta), n = Math.round(g[1] * this.oa - this.ga),
        p = this.R.lineWidth / 2 * this.R.scale;
      g = 0;
  ...
  function Pk(a) {
    ...
    var h = this.c = new H({
      controls: new Vc, interactions: new Vc,
      view: a.view
    });
  ...
  function vl() {
    ...
    a.Point = [new ql({
      image: new nl({radius: 6, fill: new pl({color: c}), stroke: new zj({color: b, width: 1.5})}),
      zIndex: Infinity
    })];
  ...
  var hm = {
    ...
    Point: function (a) {
      ...
      "XYZ" === a ? c = {x: b[0], y: b[1], z: b[2]} : "XYM" === a ? c = {
        ...
        y: b[1],
        m: b[2]
      } : "XYZM" === a ? c = {x: b[0], y: b[1], z: b[2], m: b[3]} : "XY" === a ? c = {x: b[0], y: b[1]} : va(!1, 34);
      return c
    }, LineString: function (a) {
      var b = im(a);
  ...
  k.cf = function (a, b, c) {
    ...
    "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName ? (b = b.Yd(), Ql({
      node: a,
      hasZ: e,
      srsName: d
    }, kn, this.yn, b, c, void 0, this)) : "Surface" === a.nodeName && (e = zl(a.namespaceURI, "patches"), a.appendChild(e), a = zl(e.namespaceURI, "PolygonPatch"), e.appendChild(a), this.cf(a, b, c))
  };
  k.bf = function (a, b, c) {
    var d = c[c.length - 1].srsName;
  ...
  var ln = {"http://www.opengis.net/gml": {surfaceMember: J(gn.prototype.Ai), polygonMember: J(gn.prototype.Ai)}},
    mn = {"http://www.opengis.net/gml": {pointMember: J(gn.prototype.Bn)}},
    nn = {"http://www.opengis.net/gml": {lineStringMember: J(gn.prototype.ui), curveMember: J(gn.prototype.ui)}},
    kn = {"http://www.opengis.net/gml": {exterior: J(gn.prototype.zi), interior: J(gn.prototype.zi)}}, on = {
      "http://www.opengis.net/gml": {
  ...
  gn.prototype.se = function (a, b) {
    b = Vl(this, b);
    var c = zl("http://www.opengis.net/gml", "geom"), d = {
      node: c,
      hasZ: this.hasZ,
  ...
  k.af = function (a, b, c) {
    ...
    "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName ? (b = b.Yd(), Ql({
      ...
      hasZ: e,
      srsName: d
    }, vn, this.tn, b, c, void 0, this)) : "Surface" === a.nodeName && (e = zl(a.namespaceURI, "patches"), a.appendChild(e), a = zl(e.namespaceURI, "PolygonPatch"), e.appendChild(a), this.af(a, b, c))
  };
  k.tn = function (a, b) {
    a = b[b.length - 1];
    b = a.node;
  ...
  var rn = {
    ...
    }, vn = {"http://www.opengis.net/gml": {outerBoundaryIs: J(qn.prototype.ri), innerBoundaryIs: J(qn.prototype.ri)}},
    xn = {"http://www.opengis.net/gml": {pointMember: J(qn.prototype.xn)}},
  ...
  var An = {
      ...
      MultiPolygon: "polygonMember",
      MultiSurface: "surfaceMember"
    }, yn = {"http://www.opengis.net/gml": {surfaceMember: J(qn.prototype.si), polygonMember: J(qn.prototype.si)}},
    zn = {"http://www.opengis.net/gml": {lowerCorner: J(dn), upperCorner: J(dn)}};
  ...
  var On = {rte: In, trk: Kn, wpt: Mn}, Pn = K(Cn, {rte: Gl(In), trk: Gl(Kn), wpt: Gl(Mn)}),
    Gn = K(Cn, {text: I(Q, "linkText"), type: I(Q, "linkType")}), Jn = K(Cn, {
      name: I(Q),
      cmt: I(Q),
      desc: I(Q),
      src: I(Q),
    ...
    }), Qn = K(Cn, {ele: I(Zm), time: I(Ym)}), Ln = K(Cn, {
      name: I(Q),
      cmt: I(Q),
      desc: I(Q),
      src: I(Q),
    ...
    }), Sn = K(Cn, {ele: I(Zm), time: I(Ym)}), Nn = K(Cn, {
      ele: I(Zm),
      time: I(Ym),
      magvar: I(Zm),
      geoidheight: I(Zm),
  ...
  var Wn = ["text", "type"], Vn = K(Cn, {text: J(dn), type: J(dn)}),
    ao = K(Cn, "name cmt desc src link number type rtept".split(" ")), bo = K(Cn, {
      name: J(dn),
      cmt: J(dn),
      desc: J(dn),
      src: J(dn),
      ...
      type: J(dn),
      rtept: Jl(J(Xn))
    }), Yn = K(Cn, ["ele", "time"]), co = K(Cn, "name cmt desc src link number type trkseg".split(" ")), go = K(Cn, {
      name: J(dn),
      cmt: J(dn),
      desc: J(dn),
      src: J(dn),
    ...
    $n = K(Cn, {
      ...
      ageofdgpsdata: J(en),
      dgpsid: J(fn)
    }), ho = {Point: "wpt", LineString: "rte", MultiLineString: "trk"};
  ...
  var no = /^B(\d{2})(\d{2})(\d{2})(\d{2})(\d{5})([NS])(\d{3})(\d{5})([EW])([AV])(\d{5})(\d{5})/,
    oo = /^H.([A-Z]{3}).*?:(.*)/, po = /^HFDTE(\d{2})(\d{2})(\d{2})/, qo = /\r\n|\r|\n/;
  k = mo.prototype;
  k.ge = function (a, b) {
  ...
  function vo(a) {
    a = a ? a : {};
    Rm.call(this);
    wo || (xo = [255, 255, 255, 1], yo = new pl({color: xo}), zo = [20, 2], Ao = Bo = "pixels", Co = [64, 64], Do = "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png", Eo = .5, Fo = new to({
      anchor: zo,
      ...
      size: Co,
      src: Do
    }), Go = "NO_IMAGE", Ho = new zj({color: xo, width: 1}), Io = new zj({
      color: [51, 51, 51, 1],
      width: 2
    }), Jo = new uo({font: "bold 16px Helvetica", fill: yo, stroke: Io, scale: .8}), Ko = new ql({
      fill: yo,
      image: Fo, text: Jo, stroke: Ho, zIndex: 0
    }), wo = [Ko]);
    this.defaultDataProjection = Qb("EPSG:4326");
  ...
  var Lo = ["http://www.google.com/kml/ext/2.2"],
    ...
    No = {fraction: "fraction", pixels: "pixels", insetPixels: "pixels"};
  ...
  var op = K(Mo, {displayName: I(Q), value: I(Q)}), lp = K(Mo, {
      Data: function (a, b) {
      ...
      east: I(Zm),
      west: I(Zm)
    }), rp = K(Mo, {minLodPixels: I(Zm), maxLodPixels: I(Zm), minFadeExtent: I(Zm), maxFadeExtent: I(Zm)}),
    $o = K(Mo, {extrude: I(Wm), tessellate: I(Wm), altitudeMode: I(Q)}), Wo = K(Mo, {coordinates: Hl(So)}),
    hp = K(Mo, {
    ...
    })), ap = K(Mo, {coordinates: Hl(So)}), up = K(Mo, {href: I(To)}, K(Lo, {x: I(Zm), y: I(Zm), w: I(Zm), h: I(Zm)})),
    vp = K(Mo, {
      Icon: I(function (a, b) {
    ...
    sp = K(Mo, {LinearRing: Hl(Vo)}), wp = K(Mo, {color: I(Ro), scale: I(Uo)}),
    xp = K(Mo, {color: I(Ro), width: I(Zm)}),
    dp = K(Mo, {LineString: Gl(Zo), LinearRing: Gl(bp), MultiGeometry: Gl(cp), Point: Gl(fp), Polygon: Gl(gp)}),
    yp = K(Lo, {Track: Gl(Xo)}), Ap = K(Mo, {
      ExtendedData: kp, Region: mp, Link: function (a, b) {
        Pl(zp, a, b)
      }, address: I(Q), description: I(Q), name: I(Q), open: I(Wm), phoneNumber: I(Q), visibility: I(Wm)
    }), zp = K(Mo, {href: I(To)}), tp = K(Mo, {LinearRing: Hl(Vo)}),
    Bp = K(Mo, {Style: I(ip), key: I(Q), styleUrl: I(To)}), Dp = K(Mo, {
      ExtendedData: kp,
      Region: mp,
    ...
    Ep = K(Mo, {color: I(Ro), fill: I(Wm), outline: I(Wm)}), pp = K(Mo, {
      ...
      IconStyle: function (a, b) {
        if (a = L({}, vp, a, b)) {
          ...
          void 0 !== c && (t = Fa(c));
          a = a.scale;
          d ? (e == Do && (q = Co, void 0 === a && (a = Eo)), e = new to({
            anchor: h,
            anchorOrigin: f,
            anchorXUnits: l,
            anchorYUnits: m,
  ...
  var fq = K(Mo, ["Document", "Placemark"]), iq = K(Mo, {
      Document: J(function (a, b, c) {
        Ql({node: a}, gq, hq, b, c, void 0, this)
      }), Placemark: J(Up)
    }), gq = K(Mo, {Placemark: J(Up)}), jq = K(Mo, {
    ...
    mq = K(Mo, {href: J(dn)}, K(Lo, {x: J(en), y: J(en), w: J(en), h: J(en)})),
    nq = K(Mo, ["scale", "heading", "Icon", "hotSpot"]), pq = K(Mo, {
    ...
    }), qq = K(Mo, ["color", "scale"]), rq = K(Mo, {color: J(Kp), scale: J(eq)}), sq = K(Mo, ["color", "width"]),
    tq = K(Mo, {color: J(Kp), width: J(en)}), Sp = K(Mo, {LinearRing: J(Yp)}),
    Qp = K(Mo, {LineString: J(Yp), Point: J(Yp), Polygon: J(aq), GeometryCollection: J(Lp)}),
    Xp = K(Mo, "name open visibility address phoneNumber description styleUrl Style".split(" ")), Vp = K(Mo,
    {
      ExtendedData: J(function (a, b, c) {
        a = {node: a};
        var d = b.names;
        b = b.values;
        for (var e = d.length, f = 0; f < e; f++) Ql(a, jq, uq, [{name: d[f], value: b[f]}], c)
      }),
      MultiGeometry: J(Lp),
      LineString: J(Yp),
      LinearRing: J(Yp),
      ...
      styleUrl: J(dn),
      visibility: J(cn)
    }), Zp = K(Mo, ["extrude", "tessellate", "altitudeMode", "coordinates"]), $p = K(Mo, {
      extrude: J(cn), tessellate: J(cn), altitudeMode: J(dn), coordinates: J(function (a, b, c) {
        c = c[c.length - 1];
        var d = c.layout;
        c = c.stride;
        var e;
    ...
    xq = K(Mo, {color: J(Kp)}), vq = K(Mo, ["IconStyle", "LabelStyle", "LineStyle", "PolyStyle"]), wq = K(Mo, {
  ...
  var yq = Ll("color"), uq = Ll("Data"), Wp = Ll("ExtendedData"), cq = Ll("innerBoundaryIs"), Np = Ll("Point"),
    Op = Ll("LineString"), Tp = Ll("LinearRing"), Pp = Ll("Polygon"), dq = Ll("outerBoundaryIs");
  ...
  var Mq = [null, "http://www.opengis.net/ows/1.1"], Lq = K(Mq, {
  ...
  }), Tq = K(Mq, {Voice: I(Q), Facsimile: I(Q)}), Yq = K(Mq, {
    ...
    }), Nq = K(Mq, {Title: I(Q), ServiceTypeVersion: I(Q), ServiceType: I(Q)}), Oq = K(Mq, {
    ProviderName: I(Q), ProviderSite: I(Iq), ServiceContact: I(function (a, b) {
      return L({}, $q, a, b)
    })
  });
  ...
  var tr = {"http://www.opengis.net/wfs": {totalInserted: I(an), totalUpdated: I(an), totalDeleted: I(an)}}, ur = {
  ...
  mr.prototype.v = function (a, b, c, d) {
    var e = [], f = zl("http://www.opengis.net/wfs", "Transaction"), g = d.version ? d.version : "1.1.0",
      h = "1.0.0" === g ? 2 : 3;
  ...
  var Mr = {
    Point: Ir, LineString: Jr, Polygon: Kr, MultiPoint: function (a) {
      var b = [];
      a = a.de();
  ...
  var Wr = {POINT: C, LINESTRING: M, POLYGON: D, MULTIPOINT: O, MULTILINESTRING: N, MULTIPOLYGON: P}, Vr = {
  ...
  var is = [null, "http://www.opengis.net/wms"], as = K(is, {
    ...
    }), ps = K(is, {ContactPerson: I(Q), ContactOrganization: I(Q)}),
    qs = K(is, {AddressType: I(Q), Address: I(Q), City: I(Q), StateOrProvince: I(Q), PostCode: I(Q), Country: I(Q)}),
    ms = K(is, {Format: Gl(Q)}), ns = K(is, {
      Name: I(Q), Title: I(Q), Abstract: I(Q), KeywordList: I(gs), CRS: Il(Q),
    ...
    }), ss = K(is, {Title: I(Q), OnlineResource: I(Iq), LogoURL: I(fs)}), rs = K(is, {
      westBoundLongitude: I(Zm),
      eastBoundLongitude: I(Zm), southBoundLatitude: I(Zm), northBoundLatitude: I(Zm)
    }), ls = K(is, {GetCapabilities: I(ds), GetMap: I(ds), GetFeatureInfo: I(ds)}), es = K(is, {
      Format: Il(Q), DCPType: Il(function (a, b) {
        return L({}, us, a, b)
      })
    }), us = K(is, {
      HTTP: I(function (a, b) {
    ...
    }), vs = K(is, {Get: I(bs), Post: I(bs)}),
    ts = K(is, {Name: I(Q), Title: I(Q), Abstract: I(Q), LegendURL: Il(fs), StyleSheetURL: I(bs), StyleURL: I(bs)}),
    cs = K(is, {Format: I(Q), OnlineResource: I(Iq)}), hs = K(is, {Keyword: Gl(Q)});
  ...
  var As = [null, "http://www.opengis.net/wmts/1.0"], Bs = [null, "http://www.opengis.net/ows/1.1"], ys = K(As, {
    ...
    }, K(Bs, {Title: I(Q), Identifier: I(Q)})), Gs = K(As, {
    ...
    }), Ks = K(As, {TileMatrix: I(Q), MinTileRow: I(an), MaxTileRow: I(an), MinTileCol: I(an), MaxTileCol: I(an)}),
    Hs = K(As, {Default: I(Q), Value: Il(Q)}, K(Bs, {Identifier: I(Q)})),
    Is = K(Bs, {LowerCorner: Gl(zs), UpperCorner: Gl(zs)}), Es = K(As, {
      WellKnownScaleSet: I(Q), TileMatrix: Il(function (a, b) {
        return L({}, Ls, a, b)
      })
    }, K(Bs, {SupportedCRS: I(Q), Identifier: I(Q)})), Ls = K(As, {
      TopLeftCorner: I(zs), ScaleDenominator: I(Zm), TileWidth: I(an), TileHeight: I(an), MatrixWidth: I(an),
      MatrixHeight: I(an)
    }, K(Bs, {Identifier: I(Q)}));
  ...
  function Ss(a) {
    ...
    1 == a.showLabels && (this.ta = a.lonLabelFormatter ? a.lonLabelFormatter : $e.bind(this, "EW"), this.Va = a.latLabelFormatter ? a.latLabelFormatter : $e.bind(this, "NS"), this.ga =
      void 0 == a.lonLabelPosition ? 0 : a.lonLabelPosition, this.U = void 0 == a.latLabelPosition ? 1 : a.latLabelPosition, this.C = void 0 !== a.lonLabelStyle ? a.lonLabelStyle : new uo({
      font: "12px Calibri,sans-serif",
      textBaseline: "bottom",
      fill: new pl({color: "rgba(0,0,0,1)"}),
      stroke: new zj({color: "rgba(255,255,255,1)", width: 3})
  ...
  var Ts = new zj({color: "rgba(0,0,0,0.2)"}),
  ...
  function Vs(a, b, c, d, e, f, g) {
    ...
    h.aa("XY", c);
    ob(h.G(), f) && (a.b && (c = g, d = h.ba(), f = [d[0], Aa(f[1] + Math.abs(f[1] - f[3]) * a.ga, Math.max(f[1], d[1]), Math.min(f[3], d[d.length - 1]))], c = a.b[c] ? a.b[c].Wd : new C(null), c.na(f), a.b[g] = {
      Wd: c,
      text: a.ta(b)
    }), a.f[g++] = h);
    return g
  ...
  function Ws(a, b, c, d, e, f, g) {
    ...
    h.aa("XY", c);
    ob(h.G(), f) && (a.a && (c = g, d = h.ba(), f = [Aa(f[0] + Math.abs(f[0] - f[2]) * a.U, Math.max(f[0], d[0]), Math.min(f[2], d[d.length - 2])), d[1]], c = a.a[c] ? a.a[c].Wd : new C(null), c.na(f), a.a[g] = {
      Wd: c,
      text: a.Va(b)
    }), a.c[g++] = h);
    return g
  ...
  k.Th = function (a) {
    ...
    if (!this.i || !$b(this.i, f)) {
      var g = Qb("EPSG:4326"), h = f.G(), l = f.g, m = dc(l, g, f), n = l[2], p = l[1], q = l[0], t = m[3], u = m[2],
        x = m[1];
      m = m[0];
      this.g = l[3];
      this.j = n;
  ...
  gu.prototype.u = function (a, b, c) {
    var d = a.extent, e = a.pixelRatio, f = b.Ue ? a.skippedFeatureUids : {}, g = a.viewState, h = g.projection,
      l = g.rotation, m = h.G(), n = this.a.ia(), p = au(this, a, 0);
  ...
  function Nu(a, b) {
    b = b.coordinate;
    a.o = b;
    a.g === Iu ? a.a = b.slice() : a.g === Hu ? (a.a = [[b.slice(), b.slice()]], a.I = a.a[0]) : (a.a = [b.slice(), b.slice()], a.g === Ou && (a.I = a.a));
  ...
  function fv(a) {
    ...
    if (c) {
      ...
      for (var g = 0, h = e.length; g < h; ++g) {
        ...
        p && (n += "-" + p.join("-"));
        f[n] || (f[n] = Array(2));
        if ("Circle" === l.geometry.T() && 1 === l.index) m = rv(b, l), bf(m, c) && !f[n][0] && (this.j.push([l, 0]), f[n][0] = l); else if (bf(m[0], c) && !f[n][0]) this.j.push([l, 0]), f[n][0] = l; else if (bf(m[1], c) &&
          !f[n][1]) {
  ...
  function Dv(a, b, c, d) {
    ...
    if (0 < g.length) {
      ...
      } else a.B && (f = h ? Ye(c, g[0].feature.V()) : Ze(c, m), l = d.Ka(f), ff(b, l) <= a.g && (e = !0, a.S &&
      !h && (c = d.Ka(m[0]), h = d.Ka(m[1]), c = ef(l, c), b = ef(l, h), h = Math.sqrt(Math.min(c, b)), h = h <= a.g))) && (f = c > b ? m[1] : m[0], l = d.Ka(f));
  ...
  Rv.prototype.xd = function (a, b) {
    var c = a.pixelRatio, d = a.size, e = a.viewState, f = e.center, g = e.resolution, h = this.a.ia(), l = a.viewHints,
      m = a.extent;
  ...
  function Uv(a, b, c, d, e, f, g, h, l, m, n) {
    ...
    h.c.forEach(function (a) {
      ...
      a = (e[0][0] -
        x[0]) / f;
      var n = -(e[0][1] - x[1]) / f, u = (e[1][0] - x[0]) / f, B = -(e[1][1] - x[1]) / f, ea = (e[2][0] - x[0]) / f,
        Ya = -(e[2][1] - x[1]) / f;
      e = b[0][0];
      b = b[0][1];
      g -= e;
  ...
  k.vg = function (a, b, c) {
    var d = this.c, e = c.b, f = a.viewState, g = f.projection, h = this.a, l = h.ia(), m = l.Ta(g),
      n = m.uc(f.resolution), p = m.Ca(n), q = l.be(n, a.pixelRatio, g), t = q[0] / Ka(m.eb(n), this.S)[0], u = p / t,
      x = l.Oc(t) * l.bg(g), B = f.center, z = a.extent, G = nc(m, z, p);
  ...
  v(vw, mw);
  var ww = {image: ["Polygon", "Circle", "LineString", "Image", "Text"], hybrid: ["Polygon", "LineString"]},
    xw = {image: ["Default"], hybrid: ["Image", "Text", "Default"], vector: li};
  k = vw.prototype;
  k.xd = function (a, b) {
    var c = this.a, d = c.f;
  ...
  k.qf = function (a, b, c) {
    var d = this.a, e = d.ia(), f = d.g, g = xw[f], h = b.pixelRatio, l = b.viewState.rotation, m = b.size,
  ...
  function Ww(a) {
    a = a || {};
    var b = void 0 !== a.projection ? a.projection : "EPSG:3857", c = void 0 !== a.tileGrid ? a.tileGrid : sc({
      extent: uc(b),
      maxZoom: a.maxZoom,
      minZoom: a.minZoom,
      tileSize: a.tileSize
  ...
  v(sx, Ww);
  var vx = [new vc({html: 'Map tiles by <a href="https://stamen.com/">Stamen Design</a>, under <a href="https://creativecommons.org/licenses/by/3.0/">CC BY 3.0</a>.'}), kx],
    ux = {
  ...
  function Ox(a) {
    var b = a.projection || "EPSG:3857", c = a.extent || uc(b),
      d = a.tileGrid || sc({extent: c, maxZoom: a.maxZoom || 22, minZoom: a.minZoom, tileSize: a.tileSize || 512});
    Qw.call(this, {
      attributions: a.attributions,
