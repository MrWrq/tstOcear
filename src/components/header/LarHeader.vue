<template>
  <div class="lar_top" ref="lar_top">
    <div class="w">
      <div class="l logo">
        <span> <router-link to="/home" title="返回首页">大型装备管理系统</router-link> </span>
      </div>
      <div class="l nav">
    ...
    data() {
      return {
        ...
        tabs: [
          ...
          {"name": "统计分析", "path": "/larTongji"},
          {"name": "年度核查", "path": "/larYearcheck"},
