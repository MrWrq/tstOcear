<template>
  <div class="reg_top" ref="tst_top">
    <div class="w">
      <div class="l logo">
        <span> <router-link to="/regionHome" title="返回首页">极地智能装备综合管理系统</router-link> </span>
      </div>
      <div class="l nav">
  ...
  export default {
    data() {
      return {
        activeIndex: '1',
        tabs: [
          {"name": "综合管理", "path": "/regRegionTable"},
          {"name": "安装验收", "path": "/regInstallation"},
          {"name": "维护保养", "path": "/regWeihu"},
    ...
    mounted() {
      ...
      if (pathName == "/regionHome" || pathName == "/" || pathName == "/home") {
        $(".reg_top").hide()
      }
