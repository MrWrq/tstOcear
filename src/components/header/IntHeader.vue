<template>
  <div class="int_top" ref="int_top">
    <div class="w">
      <div class="l logo">
        <span> <router-link to="/home" title="返回首页">综合管理系统</router-link> </span>
      </div>
      <div class="l nav">
...
<script>
  export default {
    ...
    mounted() {
      ...
      if (pathName == "/home" || pathName == "/regionHome" || pathName == "/" || pathName == '/obsRegionHome') {
        $(".int_top").hide()
      }
      if (pathName.substring(0, 4) == '/int') {
        $(".int_top").show()
      }
