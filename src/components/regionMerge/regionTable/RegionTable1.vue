      ...
      <div class="region_info">
        <div class="region_info_l">
          <div class="info_l_top">
            ...
            <div class="region_img_top">
              <!--<img src="static/img/region_01.png" width="100%" alt="">-->
            </div>
        ...
        <div class="region_info_r">
          ...
          <div class="info_r_top" style="height:100%">
            <!--提示组件-->
            <div class="info_title">长城站</div>
            <div style="margin-top:5px;">
              <ul style="float:left">
                <li class="selectedLi" id="li1" @click="changeLiStyle(1)">站点介绍</li>
                <li class="normalLi" id="li2" @click="changeLiStyle(2)">浮标</li>
                <li class="normalLi" id="li3" @click="changeLiStyle(3)">潜标</li>
                <li class="normalLi" id="li4" @click="changeLiStyle(4)">海洋站</li>
              </ul>
            </div>
            <!--#################内容##############-->
            <div class="info_content">
              <img src="/static/img/jidi_03.png" width="100%" alt="">
  ...
  export default {
    ...
    methods: {
      ...
      changeLiStyle(index) {
        ...
        $("li").addClass("normalLi");
        $("#li" + index).addClass("selectedLi");
        if (index == 1) {
          $('.info_content img').attr('src', '/static/jidi_03')
        }
        if (index == 2) {
          $('.info_content img').attr('src', '/static/jidi_04')
        }
      }
        ...
        .region_info_l
          ...
          .info_l_top, .info_l_bot
            ...
            .region_img_top
              ...
              height 100%
              width 100%
              background url('/static/img/jidi_01.png') no-repeat center center
          ...
          .info_l_bot
            ...
            .region_img_bot
              ...
              height 100%
              width 100%
              background url('/static/img/jidi_02.png') no-repeat center center
              background-size cover
        .region_info_r
          float left
          border-radius 4px
