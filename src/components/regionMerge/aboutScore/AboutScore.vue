<template>
  <div class="aboutScore">
    <div class="w">
      <div class="aboutScore_info">
        <div class="aboutScore_info_l">
    ...
    mounted (){
                        ...
                        series : [
                            {
                                ...
                                data:[
                                    {value:10886, name:'国内',itemStyle:{
                                         normal: {
                                         color:"#79A0EF"
                                     },
                                     }},
                                    {value:6841, name:'海外',itemStyle:{
                                        normal: {
                                          color:"#0BABFF"
                                        },
                                      }},
                                    {value:1800, name:'极地',itemStyle:{
                                        normal: {
                                          color:"#4BCEAF"
                                        },
                                      }},
      ...
      //装备子系统数量占比
        ...
        series : [
          ...
          //     })
          // }, 2000);
          $('.info_bottom_panel_tab .chartTitle ul li').on('click',function () {
            console.log('12')
            $('.info_bottom_panel_tab .chartTitle ul li').each(function (val,item) {
