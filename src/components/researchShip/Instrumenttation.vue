<template>
  <div class="insttrumenttation">
    <div class="w">
      <div class="insttrumenttation_info">
        <div class="insttrumenttation_info_l">
            ...
            <div class="search_toolbar">
              <div style="float:left">
                ...
                <div style="position:absolute;top:60px">
                  吨位：
                  <el-button type="primary" plain style="border: 0px;color: black">0-2000吨</el-button>
                  <el-button type="primary" plain style="border: 0px;color: black">2000-4500吨</el-button>
                  <el-button type="primary" style="border: 0px;color: black">4500以上</el-button>
                </div>
              </div>
              <div style="float:right">
                <!--<el-button type="primary" plain>重置</el-button>-->
                <!--<el-button type="primary" style="right: 10px">查询</el-button>-->
              </div>
            </div>
              ...
              <el-table
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    ...
                    <div>
                      <a href="#" style="color: #68C897;">可共享</a>
                    </div>
                  </template>
                </el-table-column>
              </el-table>
...
<style lang="stylus" rel="stylesheet/stylus" scoped>
  .insttrumenttation
    ...
    .w
      height 100%
      .insttrumenttation_info
        height 100%
        .insttrumenttation_info_l
          width 100%
          height 90%
          float left
          position relative
