        ...
        <div class="l info_l">
          ...
          <div class="info_l_list">
            <ul>
              ...
              <li><img src="./ocea_08.png" alt="">
                <p>海床基</p></li>
              <li><img src="./ocea_09.png" alt="">
                <p>海啸浮标</p></li>
              <li><img src="./leida1.png" alt="">
                <p>雷达</p></li>
              <!--<li></li>-->
            </ul>
          </div>
              ...
              <el-table
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    <el-button size="smail" style="padding: 0px;margin: 0px;width: 100%;border:0px;color: #00A34C;">&bull;正常</el-button>
          　　　　</template>
                </el-table-column>
                <el-table-column
                  prop="dbl"
                  ...
                  label="报到率">
                  <template slot-scope="scope">
                    <el-progress :percentage="scope.row.dbl "  size="smail" style="padding: 0px;margin: 0px;width: 100%;border:0px;color: #00A34C;"></el-progress>
                  </template>
                </el-table-column>
              </el-table>
            </div>
