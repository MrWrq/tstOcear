<template>
  <div class="aboutTongji">
    <div class="w">
      <div class="aboutTongji_info">
        <div class="aboutTongji_info_l">
          <div class="info_l_top">
            <!-- <v-title :message="titL_Top" :class=""></v-title>-->
            <div class="title_text" style="height27px;border-left:4px #0abafe solid">
              <p>{{titL_Top}}</p>
            </div>
            <div class="bot_chart_top_l">
              ...
              <div class="chartTitle clearfix">
                <ul>
                  <li><i style="background-color:#0BABFE"></i><span>飞机</span></li>
                  <li><i style="background-color:#79A0EF"></i><span>船舶</span></li>
                  <li><i style="background-color:#A360FE"></i><span>潜器</span></li>
                  <li><i style="background-color:#4BCEAF"></i><span>卫星</span></li>
                </ul>
              </div>
            </div>
          </div>
        </div>
        <div class="aboutTongji_info_r">
      ...
      <div class="info_bottom_panel">
        <div class="info_bottom_panel_tab">
          <div class="chartTitle clearfix">
            <ul>
              <li><a href="#"><span>飞机</span></a></li>
              <li><a href="#"><span>船舶</span></a></li>
              <li><a href="#"><span>潜器</span></a></li>
              <li><a href="#"><span>卫星</span></a></li>
            </ul>
          </div>
        </div>
        <div class="info_bottom_panel_content">
  ...
  export default {
    data() {
      return {
        ...
        dataTable: [
          {no: 1, name: '飞机', on: '3/7', buy: '4/7', off: '1/7', name1: '浮标'},
          {no: 2, name: '船舶', on: '7/11', buy: '2/11', off: '2/11', name1: '浮标'},
          {no: 3, name: '潜器', on: '5/9', buy: '3/9', off: '1/9', name1: '浮标'},
          {no: 4, name: '卫星', on: '1/3', buy: '1/3', off: '1/3', name1: '浮标'},
          // {date: '', name: '100', address: '34', num: '23', all: '115', name1: '浮标1'},
          // {date: '', name: '100', address: '34', num: '23', all: '115', name1: '浮标2'},
          // {date: '', name: '100', address: '34', num: '23', all: '115', name1: '浮标3'},
        ]
      }
    },
    methods: {
