          ...
          <div class="info_r_top">
            ...
            <div class="info_r_top_tab">
              <el-table
                ...
                <el-table-column label="设置种类" align="center">
            　　　　<template slot-scope="scope">
                       <el-button size="smail" style="padding: 0px;margin: 0px;width: 100%;background-color: #808080;color: #ffffff;">{{ scope.row.type }}</el-button>
            　　　　</template>
            　　</el-table-column>
                <el-table-column
                  prop="num"
            ...
            <div class="info_r_bot_bot">
              <div class="bot_l l">
                <ul class="info_r_bot_icon l">
                  <li><el-button size="mini" style="width:120px;background-color: #293CBA;color: #ffffff;">码头</el-button> </li>
                  <li><el-button size="mini" style="width:120px;background-color: #808080;color: #ffffff;">房屋</el-button> </li>
                  <li><el-button size="mini" style="width:120px;background-color: #808080;color: #ffffff;">气象站</el-button> </li>
                  <li><el-button size="mini" style="width:120px;background-color: #808080;color: #ffffff;">试验场</el-button> </li>
                </ul>
                <ul class="info_r_bot_icon l">
                  <li><el-button size="mini" style="width:120px;background-color: #808080;color: #ffffff;">科研业务用井</el-button> </li>
                  <li><el-button size="mini" style="width:120px;background-color: #808080;color: #ffffff;">科研业务用槽</el-button> </li>
                  <li><el-button size="mini" style="width:120px;background-color: #808080;color: #ffffff;">用海</el-button> </li>
                  <li><el-button size="mini" style="width:120px;background-color: #808080;color: #ffffff;">用地</el-button> </li>
                </ul>
              </div>
              <div class="bot_r l">
                <div id="chart2"></div>
    ...
    mounted (){
      ...
      $(".bot_r").height(info_r_botH)
       ...
       let option1 = {
        ...
        legend: {
          x:'right',
          data:['码头','房屋','气象','试验场','','科研井','科研槽','用海','用地']
        },
         grid: {
          x: 45,
          y: 55,
       ...
       let myChart2 = echarts.init(document.getElementById('info_r_mid_chart'));
       myChart2.setOption(option1);

      //初始化海域数量分布环形图
      let  bottom_pie_option = {
        title : {
          x:'right'
        },
      ...
      let bottom_pie_chart = echarts.init(document.getElementById('chart2'))
      bottom_pie_chart.setOption(bottom_pie_option);
      ...
      function globalviewercore() {
        ...
        var k = new ol.layer.Tile({
          ...
          source: new ol.source.WMTS({
            ...
            format: "tiles",
            projection: L,
            tileGrid: new ol.tilegrid.WMTS({origin: ol.extent.getTopLeft(J), resolutions: T, matrixIds: F}),
            style: "default"
          })
        });
        ...
        var O = new ol.layer.Tile({
          type: "base",
          source: new ol.source.XYZ({url: "http://127.0.0.1:3666/{z}/{x}/{y}.png"}),
          projection: "EPSG:3857"
        });
