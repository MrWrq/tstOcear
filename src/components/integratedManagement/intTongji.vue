  ...
  export default {
    data() {
      return {
        ...
        dataTable: [
          {date: '1', name: '100', address: '2/7', num: '2/7', all: '飞机', name1: '浮标'},
          {date: '2', name: '100', address: '3/11', num: '3/11', all: '船舶', name1: '浮标1'},
          {date: '3', name: '100', address: '5/9', num: '1/3', all: '卫星', name1: '浮标2'},
          {date: '4', name: '100', address: '1/3', num: '7/11', all: '潜器', name1: '浮标3'},
          {date: '5', name: '100', address: '7/11', num: '3/11', all: '飞机', name1: '浮标4'},
          {date: '6', name: '100', address: '3/11', num: '3/11', all: '船舶', name1: '浮标1'},
          {date: '7', name: '100', address: '5/9', num: '1/3', all: '卫星', name1: '浮标2'},
          {date: '8', name: '100', address: '1/3', num: '7/11', all: '潜器', name1: '浮标3'},
          {date: '9', name: '100', address: '7/11', num: '3/11', all: '飞机', name1: '浮标4'},
        ]
      }
    },
    methods: {
