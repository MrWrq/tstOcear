      ...
      <div class="info_top_panel">
        <div class="info_top_panel_tab">
          <div class="chartTitle clearfix">
            <ul>
              <li class="active"><i style="background-color:#0BABFE"></i><span>海洋站</span></li>
              <li><i style="background-color:#79A0EF"></i><span>船舶</span></li>
              <li><i style="background-color:#6DB820"></i><span>潜器</span></li>
              <li><i style="background-color:#FFAC1E"></i><span>卫星</span></li>
            </ul>
          </div>
        </div>
  ...
  export default {
    data() {
      return {
        ...
        dataTable: [
          {date: '1', name: '飞机', address: '23', num: '23', all: '飞机', name1: '浮标'},
          {date: '2', name: '船舶', address: '34', num: '23', all: '船舶', name1: '浮标1'},
          {date: '3', name: '潜器', address: '34', num: '23', all: '潜器', name1: '浮标2'},
          {date: '4', name: '卫星', address: '34', num: '23', all: '卫星', name1: '浮标3'},
          {date: '5', name: '船舶', address: '34', num: '23', all: '船舶', name1: '浮标1'},
          {date: '6', name: '潜器', address: '34', num: '23', all: '潜器', name1: '浮标2'},
          {date: '7', name: '卫星', address: '34', num: '23', all: '卫星', name1: '浮标3'},
        ]
      }
    },
    methods: {
